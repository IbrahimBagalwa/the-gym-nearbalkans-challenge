...
export default function Modal({ open, onclose }) {
  ...
  return (
    <div>
      <div className='relative z-10 transition duration-2000 ease-in-out'>
        <div className='fixed inset-0 bg-black bg-opacity-25 opacity-100'></div>
        <div className='fixed lg:inset-56 inset-0 lg:mt-0 mt-48 mx-5 min-h-full overflow-y-auto'>
          <div className=''>
            <div className='relative bg-white rounded-[28px] lg:w-[454px] mx-auto opacity-100 scale-100'>
              <h3
                className='text-lg font-medium leading-6 text-gray-900'
                id='headlessui-dialog-title-:re:'
                data-headlessui-state='open'
              >
                <div className='flex items-center text-black px-6 py-[23px] border-b border-solid border-gray-200'>
                  <span className=' font-medium text-xl tracking-tight w-[98%]'>
                    Choose language
                  </span>
                  <span className='justify-items-end' onClick={onclose}>
                    <svg
                      width='12'
                      height='12'
                      fill='none'
              ...
              <div className='my-[26px]'>
                <div className='relative mx-[26px] font-primary rounded-xl '>
                  <div className='pb-8'>
                    <div className='pb-[16px] outline-none'>
                      <Link
                        href='#'
                        className='flex px-[20px] py-[10px] items-center text-black border border-solid border-gray-200 rounded-lg'
                      >
                        <span>
                          <svg
                            width='21'
                        ...
                        <span className='ml-2 lg:w-[80%] w-[76%]'>
                          Croatian
                        </span>
                        <span className='lg:w-[36px] lg:h-[36px] w-[25px] h-[25px] rounded-full bg-gray-200 mx-auto flex items-center'>
                          <svg
                            width='8'
                            height='14'
                            fill='none'
                      ...
                      >
                        <span>
                          ...
                          >
                            ...
                            <path
                              fill='#1AAF5D'
                              d='M0 4.813h21v4.375H0z'
                            ></path>
                            <path
                              fill='#E94B35'
                              d='M0 9.188h21v4.813H0z'
                            ></path>
                          </svg>
                        </span>
                        <span className='ml-2 lg:w-[80%] w-[76%]'>
