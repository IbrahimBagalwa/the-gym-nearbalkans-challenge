...
export default function Hero() {
  return (
    <>
      <div className='bg-page-gradient absolute lg:-top-[550px] -top-[520px] opacity-[0.4] left-0 lg:-left-48 h-[100%] w-[50%] z-50 mt-28 lg:mt-16'></div>
      <div className='bg-page-gradient absolute lg:-top-[550px] -top-[520px] opacity-[0.4] right-0 lg:right-0 h-[100%] w-[40%] z-50 mt-28 lg:mt-16'></div>
      <div className=' text-center lg:w-[910px] mx-auto font-global-font lg:mt-16 mt-28'>
